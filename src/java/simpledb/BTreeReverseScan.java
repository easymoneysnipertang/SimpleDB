...
/**
 * use BTreeScan as a starting point-> copy up!
...
public class BTreeReverseScan implements OpIterator {
	...
	/**
	 * Creates a B+ tree reverseScan over the specified table as a part of the
	...
	public void reset(int tableid, String tableAlias) {
		...
		// TODO: implement reverseIterator & reverseIndexIterator
		if(ipred == null) {
